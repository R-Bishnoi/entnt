    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <DemoContainer components={['DateTimePicker']}>
        <Grid container spacing={3} className="form">
          ...
          fullWidth
        /> */}
            <DateTimePicker onChange={(value) => { setFormData({ ...formData, date: value }) }} name="date" label="Basic date time picker" />
          </Grid>
          <Grid item xs={12}>
            <Button sx={{ mr: 2 }} variant="contained" color="primary" onClick={handleAddAppointment}>Add Appointment</Button>
            <Button sx={{ mx: 2 }} variant="contained" color="primary" onClick={handleSave}>Save</Button>
          </Grid>
        </Grid>
